...
<div class="container mt-5">
    <div class="row justify-content-center">
        <x-card card="Here You Can Add New Majors to the Clinic"/>
        <div class="col-md-6">
            @if(session('suc'))
        <div class="alert alert-success">
            ...
            <form class="custom-form" action="{{ route('createmajor') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-title">Create New Major</div>

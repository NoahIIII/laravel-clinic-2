        ...
        <div class="row justify-content-center">
            <div class="custom-card">
                <div class="card-text">
                    ...
                    <a href="{{ route('dashboard') }}" class="btn btn-submit"> < Back to the dashboard main page</a>
            ...
            <div class="col-md-6">
                ...
                <form class="custom-form" action="{{ route('destroyuser') }}" method="POST">
                    @csrf
                    @method('delete')
                    <div class="form-title">Remove User</div>
                    ...
                    <button type="submit" class="btn btn-submit">Remove User</button>
                </form>
            </div>
        </div>
</div>

...
<div class="container mt-5">
    <div class="row justify-content-center">
        <x-card card="Here You Can Update Booking Status accept or cancle"/>
        <div class="col-md-6">
            @if(session('suc'))
        <div class="alert alert-success">
            ...
            <form class="custom-form" action="{{ route('bookingedit',$id) }}" method="POST">
                @csrf
                @method('put')
                <div class="form-title">Update Booking Status</div>
                <div class="form-group">
                    <label for="booking-status" class="form-label">Booking Status : Pending</label>
